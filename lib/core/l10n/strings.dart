...
const _hi = {
  ...
  'Call': 'कॉल',
  'Info': 'जानकारी',
  'Phone number not available': 'फोन नंबर उपलब्ध नहीं',
  'Calling is not supported on this device': 'इस डिवाइस पर कॉल समर्थित नहीं है',
  'Could not load messages': 'मैसेज लोड नहीं हुए',
  'Say hello!': 'नमस्ते कहें!',
  'Translation failed. Try again.': 'अनुवाद नहीं हुआ। फिर कोशिश करें।',
  'Message not sent. Try again.': 'मैसेज नहीं भेजा गया। फिर कोशिश करें।',
  'Type a message…': 'मैसेज लिखें…',
  'Could not load details': 'विवरण लोड नहीं हुआ',
  'Phone': 'फोन',
  'ID': 'आईडी',
  'Type': 'प्रकार',
  'Boarding Stop': 'बोर्डिंग स्टॉप',
  'Email': 'ईमेल',
  'Not provided': 'उपलब्ध नहीं',
  'Passenger': 'यात्री',
  'Display Name': 'प्रदर्शन नाम',
  'Save': 'सहेजें',
  'Search by name or ID': 'नाम या आईडी से खोजें',
  ...
  'Pending bus join requests': 'लंबित बस ज्वाइन अनुरोध',
  ...
  'Failed to approve request': 'अनुरोध स्वीकार नहीं हुआ',
  'Failed to reject request': 'अनुरोध अस्वीकार नहीं हुआ',
  'Failed to approve reservation': 'आरक्षण स्वीकार नहीं हुआ',
  'No pending requests': 'कोई लंबित अनुरोध नहीं',
  'No pending reservations': 'कोई लंबित आरक्षण नहीं',
  'Leave Bus': 'बस छोड़ें',
  'Remove yourself from this bus': 'इस बस से खुद को हटाएं',
  'Failed to leave bus. Please try again.': 'बस नहीं छोड़ी गई। फिर कोशिश करें।',
  'Failed to save changes.': 'परिवर्तन सहेजे नहीं गए।',
