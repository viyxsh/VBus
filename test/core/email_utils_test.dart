...
void main() {
  ...
  group('isStudentEmail', () {
    test('valid student emails', () {
      expect(
        EmailUtils.isStudentEmail('viya.23bce11351@vitbhopal.ac.in'),
        isTrue,
      );
      expect(
        EmailUtils.isStudentEmail('john.21mca10001@vitbhopal.ac.in'),
        isTrue,
      );
      // VIT Bhopal uses 3-letter program codes (BCE/MCA/MBA etc.)
      expect(
        EmailUtils.isStudentEmail('alice.22mba10042@vitbhopal.ac.in'),
        isTrue,
      );
    });
    ...
    test('rejects malformed student patterns', () {
      ...
      expect(
        EmailUtils.isStudentEmail('viya.23bce1135@vitbhopal.ac.in'),
        isFalse,
      );
      // Missing year digits
      expect(
        EmailUtils.isStudentEmail('viya.bce11351@vitbhopal.ac.in'),
        isFalse,
      );
    });
  });
  ...
  group('isFacultyEmail', () {
    ...
    test('rejects student email', () {
      expect(
        EmailUtils.isFacultyEmail('viya.23bce11351@vitbhopal.ac.in'),
        isFalse,
      );
    });
  ...
  group('isValidUniversityEmail', () {
    test('accepts student and faculty vitbhopal emails', () {
      expect(
        EmailUtils.isValidUniversityEmail('viya.23bce11351@vitbhopal.ac.in'),
        isTrue,
      );
      expect(
        EmailUtils.isValidUniversityEmail('prof.sharma@vitbhopal.ac.in'),
        isTrue,
      );
    });
    ...
    test('rejects non-university emails', () {
      ...
      expect(
        EmailUtils.isValidUniversityEmail('conductor_11@vbus.internal'),
        isFalse,
      );
    ...
    test('rejects similar-looking but wrong domains', () {
      ...
      expect(
        EmailUtils.isValidUniversityEmail('user@notVitbhopal.ac.in'),
        isFalse,
      );
    });
  });
  ...
  group('conductorEmail', () {
    test('lowercases username and appends domain', () {
      expect(
        EmailUtils.conductorEmail('Conductor_11'),
        'conductor_11@vbus.internal',
      );
      expect(
        EmailUtils.conductorEmail('CONDUCTOR_01'),
        'conductor_01@vbus.internal',
      );
      expect(
        EmailUtils.conductorEmail('conductor_05'),
        'conductor_05@vbus.internal',
      );
    });
